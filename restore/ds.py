...
run_cmd("mkdir -p /Users/kirill/aram/ops/odoo-modules-darkstore-14/datadir/filestore/ds")
run_cmd("cp -r /tmp/db/filestore/* /Users/kirill/aram/ops/odoo-modules-darkstore-14/datadir/filestore/ds")
run_cmd("rm -rf /tmp/db")
