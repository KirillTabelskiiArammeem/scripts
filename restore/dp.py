...
run_cmd("mkdir -p /Users/kirill/aram/ops/rep_supply/driver-portal/datadir/filestore/dp")
run_cmd("cp -r /tmp/db/filestore/* /Users/kirill/aram/ops/rep_supply/driver-portal/datadir/filestore/dp")
run_cmd("rm -rf /tmp/db")
